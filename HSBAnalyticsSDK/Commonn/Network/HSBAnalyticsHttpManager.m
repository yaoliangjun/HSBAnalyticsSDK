...
@interface HSBAnalyticsHttpManager () <NSURLSessionDelegate>
...
@implementation HSBAnalyticsHttpManager

- (instancetype)init {
    self = [super init];
    if (self) {
        // TODO: 服务器URL
        _serverURL = [NSURL URLWithString:@"请替换成真实URL"];
